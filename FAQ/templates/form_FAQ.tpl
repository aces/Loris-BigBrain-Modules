...
<dl class="question">
    ...
    <dd>The volumes are represented in either stereotaxic space (MNI-ICBM152 or
       ...
       MINC (.mnc) and NIfTI (.nii) formats.
    </dd>
    ...
    <dt>The intensities are wrong in the NIfTI volumes. How can I view them correctly?</dt>
    <dd>There was a problem with the initial data conversion to NIfTI format. The NIfTI
    ...
    <dt>Where are the 100um NIfTI volumes?</dt>
    <dd>The 100um NIfTI volumes cannot be created because they are too large for the
    data converter.</dd>
    ...
    <dt>How can I view the OBJ surfaces?</dt>
    <dd>
      The OBJ surfaces are viewable in
      <A HREF="https://brainbrowser.cbrain.mcgill.ca">BrainBrowser</A>,
      in the <A HREF="http://www.math.mcgill.ca/keith/surfstat">Surfstat (MATLAB-based) toolbox</A>,
      in <A HREF="https://wiki.mouseimaging.ca/display/MICePub/brain-view">brain-view</A>,
      or can be overlaid on the corresponding volume in Display which is part of the MINC Tool Kit
      mentioned above.
    </dd>
