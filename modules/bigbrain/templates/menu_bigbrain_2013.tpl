...
<p><b>The BigBrain dataset</b> is the result of a collaborative effort between the teams of Dr. Katrin Amunts and Dr. Karl Zilles and <A HREF="https://cbrain.mcgill.ca/">Dr. Alan Evans</A> (<A HREF="http://www.mni.mcgill.ca/">Montreal Neurological Institute</A>). For research purposes only, no commercial use without written consent.</p>
